...
const AboutUs = () => {
  return (
    <div 
    id="aboutus"
     className="bg-white min-h-screen flex justify-between flex-col md:flex-row">
      
      <div className="bg-white md:w-1/2 flex justify-center items-center  rounded-lg ">
        <div className="md:py-8 md:px-16 px-8 py-12">
        <h1 className="md:text-5xl  font-semibold ">About us</h1>
        <h2 className="md:text-4xl  text-3xl  font-semibold text-gray-700">
        
          Dr. Kavish Jhawar
        </h2>
        <h2 className="md:text-2xl  text-xl  font-semibold text-gray-600">
            MBBS, DLO, DNB(ENT)
          </h2>
